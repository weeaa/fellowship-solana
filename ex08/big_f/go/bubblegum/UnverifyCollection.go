...
func (inst *UnverifyCollection) SetRoot(root [32]uint8) *UnverifyCollection {
	inst.Root = &root
	return inst
}

// SetDataHash sets the "dataHash" parameter.
func (inst *UnverifyCollection) SetDataHash(dataHash [32]uint8) *UnverifyCollection {
	inst.DataHash = &dataHash
	return inst
}

// SetCreatorHash sets the "creatorHash" parameter.
func (inst *UnverifyCollection) SetCreatorHash(creatorHash [32]uint8) *UnverifyCollection {
	inst.CreatorHash = &creatorHash
	return inst
}

// SetNonce sets the "nonce" parameter.
func (inst *UnverifyCollection) SetNonce(nonce uint64) *UnverifyCollection {
	inst.Nonce = &nonce
	return inst
}

// SetIndex sets the "index" parameter.
func (inst *UnverifyCollection) SetIndex(index uint32) *UnverifyCollection {
	inst.Index = &index
	return inst
}

// SetMessage sets the "message" parameter.
func (inst *UnverifyCollection) SetMessage(message MetadataArgs) *UnverifyCollection {
	inst.Message = &message
	return inst
}

// SetTreeAuthorityAccount sets the "treeAuthority" account.
func (inst *UnverifyCollection) SetTreeAuthorityAccount(treeAuthority ag_solanago.PublicKey) *UnverifyCollection {
	inst.AccountMetaSlice[0] = ag_solanago.Meta(treeAuthority)
	return inst
}

// GetTreeAuthorityAccount gets the "treeAuthority" account.
func (inst *UnverifyCollection) GetTreeAuthorityAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(0)
}

// SetLeafOwnerAccount sets the "leafOwner" account.
func (inst *UnverifyCollection) SetLeafOwnerAccount(leafOwner ag_solanago.PublicKey) *UnverifyCollection {
	inst.AccountMetaSlice[1] = ag_solanago.Meta(leafOwner)
	return inst
}

// GetLeafOwnerAccount gets the "leafOwner" account.
func (inst *UnverifyCollection) GetLeafOwnerAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(1)
}

// SetLeafDelegateAccount sets the "leafDelegate" account.
func (inst *UnverifyCollection) SetLeafDelegateAccount(leafDelegate ag_solanago.PublicKey) *UnverifyCollection {
	inst.AccountMetaSlice[2] = ag_solanago.Meta(leafDelegate)
	return inst
}

// GetLeafDelegateAccount gets the "leafDelegate" account.
func (inst *UnverifyCollection) GetLeafDelegateAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(2)
}

// SetMerkleTreeAccount sets the "merkleTree" account.
func (inst *UnverifyCollection) SetMerkleTreeAccount(merkleTree ag_solanago.PublicKey) *UnverifyCollection {
	inst.AccountMetaSlice[3] = ag_solanago.Meta(merkleTree).WRITE()
	return inst
}

// GetMerkleTreeAccount gets the "merkleTree" account.
func (inst *UnverifyCollection) GetMerkleTreeAccount() *ag_solanago.AccountMeta {
...
func (inst *UnverifyCollection) SetTreeDelegateAccount(treeDelegate ag_solanago.PublicKey) *UnverifyCollection {
	inst.AccountMetaSlice[5] = ag_solanago.Meta(treeDelegate)
	return inst
}

// GetTreeDelegateAccount gets the "treeDelegate" account.
func (inst *UnverifyCollection) GetTreeDelegateAccount() *ag_solanago.AccountMeta {
...
func (inst *UnverifyCollection) SetCollectionAuthorityRecordPdaAccount(collectionAuthorityRecordPda ag_solanago.PublicKey) *UnverifyCollection {
...
func (inst *UnverifyCollection) GetCollectionAuthorityRecordPdaAccount() *ag_solanago.AccountMeta {
...
func (inst *UnverifyCollection) SetEditionAccountAccount(editionAccount ag_solanago.PublicKey) *UnverifyCollection {
	inst.AccountMetaSlice[10] = ag_solanago.Meta(editionAccount)
	return inst
}

// GetEditionAccountAccount gets the "editionAccount" account.
func (inst *UnverifyCollection) GetEditionAccountAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(10)
}

// SetBubblegumSignerAccount sets the "bubblegumSigner" account.
func (inst *UnverifyCollection) SetBubblegumSignerAccount(bubblegumSigner ag_solanago.PublicKey) *UnverifyCollection {
	inst.AccountMetaSlice[11] = ag_solanago.Meta(bubblegumSigner)
	return inst
}

// GetBubblegumSignerAccount gets the "bubblegumSigner" account.
func (inst *UnverifyCollection) GetBubblegumSignerAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(11)
}

// SetLogWrapperAccount sets the "logWrapper" account.
func (inst *UnverifyCollection) SetLogWrapperAccount(logWrapper ag_solanago.PublicKey) *UnverifyCollection {
	inst.AccountMetaSlice[12] = ag_solanago.Meta(logWrapper)
	return inst
}

// GetLogWrapperAccount gets the "logWrapper" account.
func (inst *UnverifyCollection) GetLogWrapperAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(12)
}

// SetCompressionProgramAccount sets the "compressionProgram" account.
func (inst *UnverifyCollection) SetCompressionProgramAccount(compressionProgram ag_solanago.PublicKey) *UnverifyCollection {
...
func (inst *UnverifyCollection) GetCompressionProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(13)
}

// SetTokenMetadataProgramAccount sets the "tokenMetadataProgram" account.
func (inst *UnverifyCollection) SetTokenMetadataProgramAccount(tokenMetadataProgram ag_solanago.PublicKey) *UnverifyCollection {
	inst.AccountMetaSlice[14] = ag_solanago.Meta(tokenMetadataProgram)
	return inst
}

// GetTokenMetadataProgramAccount gets the "tokenMetadataProgram" account.
func (inst *UnverifyCollection) GetTokenMetadataProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(14)
}

// SetSystemProgramAccount sets the "systemProgram" account.
func (inst *UnverifyCollection) SetSystemProgramAccount(systemProgram ag_solanago.PublicKey) *UnverifyCollection {
	inst.AccountMetaSlice[15] = ag_solanago.Meta(systemProgram)
	return inst
}

// GetSystemProgramAccount gets the "systemProgram" account.
func (inst *UnverifyCollection) GetSystemProgramAccount() *ag_solanago.AccountMeta {
...
func NewUnverifyCollectionInstruction(
	...
	systemProgram ag_solanago.PublicKey) *UnverifyCollection {
